...
public boolean returnStatus() throws SQLException
{
String status = "";
...
show_stmt.setInt( 1, 32000 );
show_stmt.executeUpdate();
status = show_stmt.getString(3);
    return status.startsWith("OK");
}

public String returnExecution() throws SQLException
{
int done = 0;
String execution = "";
...
show_stmt.setInt( 1, 32000 );
show_stmt.executeUpdate();
execution += show_stmt.getString(3);
if ( (done = show_stmt.getInt(2)) == 1 ) break;
}
return execution;
}
