...
public class SfwWizardOracleValidator extends javax.swing.JPanel implements SfwWizardPage {
    ...
    public SfwWizardOracleValidator(SfwInstaladorScriptView view) {
        ...
        //  if (Profile.isSet()) {
        //      this.jTextFieldTNS.setText(Profile.get_tns());
        //  }
    }
                    ...
                    .add(jPanel2Layout.createSequentialGroup()
                        ...
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel2Layout.createSequentialGroup()
                                ...
                                .add(jTextFieldRole, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 104, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel2Layout.createSequentialGroup()
                                .add(jLabel9)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .add(jTextFieldSombra, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 104, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel2Layout.createSequentialGroup()
                                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(jLabel2)
                                    .add(jLabel4))
                                ...
                                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                    .add(jTextFieldJava)
                                    .add(jTextFieldVersion, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 103, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jLabel5)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel2Layout.createSequentialGroup()
                                .add(jLabel7)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jTextFieldPermission))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel2Layout.createSequentialGroup()
                                .add(76, 76, 76)
                                .add(jTextFieldParameters)))))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .add(jPanel2Layout.createSequentialGroup()
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(jPanel2Layout.createSequentialGroup()
                        .add(jPanel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
                        .add(11, 11, 11)
                        ...
                        .add(18, 18, 18)
                        .add(jButtonValidate))
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jScrollPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 279, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
            ...
            protected Object doInBackground() throws Exception {
                ...
                try {
                    ...
                    if (ebs) {
                        ...
                        jTextFieldSombra.setText("OK");
                        jTextFieldSombra.setForeground(new Color(0, 150, 0));
                        jTextFieldRole.setText("OK");
                        jTextFieldRole.setForeground(new Color(0, 150, 0));
                    ...
                    if (!v_oraclevalidationresult_vversion.get_result().equals(OracleValidationResult.Result.ERROR)
                            ...
                            && (ebs || !v_oraclevalidationresult_result_permissionsombra.get_result().equals(OracleValidationResult.Result.ERROR))) {
                        try {
                            WriteValidations();
                        } catch (Exception e) {
                            e.printStackTrace();
